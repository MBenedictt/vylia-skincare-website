...
const Footer = () => {
    ...
    return (
        <div className='w-full pt-10 bg-gradient-to-t from-white to-green-100'>
            <div className='px-10 py-10 flex justify-between items-center max-[991px]:flex-col max-[991px]:items-start'>
                <div className='w-[500px] max-lg:w-[400px] max-sm:w-full'>
                    <h1 className='text-6xl max-lg:text-5xl max-sm:text-4xl font-semibold text-green-300 mb-4 leading-[75px] max-lg:leading-[60px] max-sm:leading-[50px] max-sm:w-3/4'>Treat Your Skin With Love</h1>
                </div>
                <div className='grid grid-cols-2 gap-10 mr-20 max-[991px]:mr-0 max-[991px]:mt-10'>
                    <ul>
                        <li className='text-green-400 text-[18px] pb-1'>Discover</li>
                    ...
                    <ul>
                        <li className='text-green-400 text-[18px] pb-1'>About Us</li>
